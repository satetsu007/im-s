...
def start(video_path, cascade_path, save_dir='img', extension='png',
          resize_size=(200, 200), fps=50,  resize=True, pad=True,):
    """動画から、画像の取得を開始する"""
...
if __name__ == '__main__':
    ...
    nlist = []
    for i in range(1, 26):
        nlist.append(str(i).rjust(2, "0"))
    for i in nlist:
        start('movie/THE IDOL M@STER %s.mp4' % i , 'lbpcascade_animeface.xml',
              save_dir='imas/%s' % i, fps=10, extension='jpg')
